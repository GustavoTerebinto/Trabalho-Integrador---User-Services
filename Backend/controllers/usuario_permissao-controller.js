...
// POST /usuario-permissao - Criar nova associação usuário-permissão
usuarioPermissaoRouter.post("/", usuarioPermissaoService.criaUsuarioPermissao);

// GET /usuario-permissao/todos - Retornar todas as associações usuário-permissão
usuarioPermissaoRouter.get("/todos", usuarioPermissaoService.retornaTodosUsuarioPermissoes);

// GET /usuario-permissao/usuario/:email - Retornar todas as permissões de um usuário
usuarioPermissaoRouter.get(
	"/usuario/:email",
	usuarioPermissaoService.retornaPermissoesPorUsuario,
);

// GET /usuario-permissao/permissao/:id_permissao - Retornar todos os usuários com uma permissão
usuarioPermissaoRouter.get(
	"/permissao/:id_permissao",
	usuarioPermissaoService.retornaUsuariosPorPermissao,
);

// GET /usuario-permissao/verificar/:email/:id_permissao - Verificar se usuário tem permissão
usuarioPermissaoRouter.get(
	"/verificar/:email/:id_permissao",
	usuarioPermissaoService.verificaPermissaoUsuario,
);

// DELETE /usuario-permissao/:email/:id_permissao - Deletar associação usuário-permissão
